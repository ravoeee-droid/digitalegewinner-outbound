...
const inputSchema=z.object({audience:z.string().min(3).max(1000),offer:z.string().min(3).max(1000),sender:z.string().max(200).default("Walkenhorst Energie"),tone:z.string().max(100).default("seriös, knapp, persönlich")});
