...
import DGCoreHologram from "./DGCoreHologram";
import styles from "./outbound-command-center.module.css";
import premium from "./outbound-command-center-premium.module.css";
...
export default function OutboundCommandCenter(){
 ...
 return <main className={`${styles.shell} ${premium.shell}`}>
