...
const publicPrefixes=["/login","/api/auth/login","/a/","/api/track","/api/events/inbound","/api/cron/","/api/oauth/google/callback","/api/oauth/microsoft/callback","/api/video/callback"];
